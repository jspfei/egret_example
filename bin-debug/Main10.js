...
var Main10 = (function (_super) {
    __extends(Main10, _super);
    function Main10() {
    ...
    Main10.prototype.onAddToStage = function () {
        this.runGame().catch(function (e) { });
    };
    Main10.prototype.runGame = function () {
    ...
    Main10.prototype.loadResource = function () {
        return __awaiter(this, void 0, void 0, function () {
            var e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Main10.prototype.createGameScene = function () {
        this.initGraphics();
        this.changeGraphics();
    };
    Main10.prototype.initGraphics = function () {
        var shape = this.shape;
        this.addChild(shape);
        this.drawCircle(this.stage.stageWidth / 2, this.stage.stageHeight / 2);
    };
    Main10.prototype.drawCircle = function (x, y) {
        var shape = this.shape;
    ...
    Main10.prototype.changeGraphics = function () {
        var _this = this;
        this.stage.addEventListener(egret.TouchEvent.TOUCH_TAP, function (e) {
            _this.drawCircle(e.stageX, e.stageY);
        }, this);
    };
    return Main10;
}(egret.DisplayObjectContainer));
__reflect(Main10.prototype, "Main10");
