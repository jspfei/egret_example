...
var Main9 = (function (_super) {
    ...
    Main9.prototype.onAddToStage = function () {
        this.runGame().catch(function (e) {
        });
    };
    Main9.prototype.runGame = function () {
    ...
    Main9.prototype.loadResource = function () {
        return __awaiter(this, void 0, void 0, function () {
            var error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Main9.prototype.createBitmapByName = function (name) {
        var result = new egret.Bitmap();
        var texture = RES.getRes(name);
        result.texture = texture;
        return result;
    };
    Main9.prototype.createGameScene = function () {
        this.initGraphics();
        this.changeGraphics();
    };
    Main9.prototype.initGraphics = function () {
    ...
    Main9.prototype.changeGraphics = function () {
